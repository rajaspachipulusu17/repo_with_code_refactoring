...
def finding_initial_ip(module, current_switch, leaf_list, task, msg):
    """
    ...
    for leaf in leaf_list:
        ...
        count_output += int(run_command(module, cli, task, msg).split(':')[1].strip())
...
def auto_configure_link_ips(module, CHANGED_FLAG, task, msg):
    ...
    if current_switch in leaf_list:
        ...
        count_output = finding_initial_ip(module, current_switch, leaf_list, task, msg)
        if addr_type == 'ipv4' or addr_type == 'ipv4_ipv6':
            count = 0
